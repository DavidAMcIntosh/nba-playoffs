                        ...
                        <div className="flex flex-col sm:flex-row mt-10">
                            <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                                <div className="w-20 h-20 rounded-full inline-flex items-center justify-center">
                                    <img alt="gallery" class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src={user.photoURL} />
                                </div>
                            ...
                            <img alt="content" class="object-cover object-center h-full w-full" src="/featured.jpeg" />
                            </div>
                        </div>
                    </div>
                </div>
