...
export default function PredictionsPage({ user, predictions }) {
    ...
    return (
        <main>
            <Metatags title="Playoff Overtime | Predictions" description="View or edit your playoff predictions." />
            {predictions.length === 0 && (
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-24 mx-auto">
                        <div class="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto">
                            <h1 class="flex-grow sm:pr-16 text-2xl font-medium title-font text-gray-900">Predict the 2022 NBA Playoffs.</h1>
