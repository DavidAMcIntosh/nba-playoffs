...
export default function Signup() {
    ...
    return (
        <>
            <Metatags title="Sign Up | Playoff Overtime" description="Sign up to join the fun." />
            <section className="text-gray-600 body-font">
                <form className="container px-5 py-24 mx-auto flex flex-wrap items-center" onSubmit={onSubmit}>
                    <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
                        ...
                        <p className="mt-2 text-sm text-gray-500">Select an image below to use as your profile pic.</p>
                        <br />
                        <div className="flex flex-wrap w-1/2">
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/celtics.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/celtics.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/jazz.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" value="/jazz.png" src="/jazz.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/grizzlies.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/grizzlies.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/spurs.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/spurs.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/heat.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/heat.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/bulls.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/bulls.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/bucks.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/bucks.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/suns.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/suns.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/wolves.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/wolves.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/hawks.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/hawks.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/nets.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/nets.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/76ers.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/76ers.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/raptors.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/raptors.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/hornets.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/hornets.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/pelicans.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/pelicans.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/warriors.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/warriors.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/cavs.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/cavs.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/6">
                                <input onChange={(e) => setPhoto(e.target.value)} name="photoURL" value="/mavs.png" type="radio" />
                                <Image height="80px" width="80px"  alt="gallery" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/mavs.png" />
                            </div>
